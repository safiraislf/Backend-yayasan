                ...
                <tbody>
                  @foreach ($data as $d)
                    <tr>
                      ...
                      <td>{{ $d->final}}</td>
                      <td>
                        <a href="" class="btn btn-primary"><i class="fas fa-pen"></i>Hasil</a>
                    </td>
                      <td>
                        <form action="{{route('min.updatejadwal')}}">
                          <input type="hidden" name="id" value="{{ $d->id }}">
                          <button class="btn btn-success" type="submit"><i class="fas fa-pen"></i>Update</button>
                        </form>
