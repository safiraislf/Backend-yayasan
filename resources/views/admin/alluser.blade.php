...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <a href="{{route('min.create')}}" class="btn btn-primary mb-3">Tambah Data</a>
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$d->email}}</td>
                            <td>
                                <a href="{{route('min.edit',['id' => $d->id])}}" class="btn btn-primary"><i class="fas fa-pen"></i>Edit</a>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                    <form action="{{route('min.delete',['id' => $d->id])}}" method="POST">
                                        @csrf
                                        @method('DELETE')
